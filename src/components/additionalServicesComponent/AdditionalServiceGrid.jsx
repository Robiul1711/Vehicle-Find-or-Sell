import { CustomCar2, CustomDelivery, CustomGarage, CustomInsurance, CustomPurchase, CustomRegistration, CustomShowroom, CustomValuation, CustomWarranty } from '@/utils/IconProvider';
...
const ServicesData = [
    ...
    },
    {
        ...
        desc: 'Discover our vehicles as if you were at the dealership with our interactive virtual showroom: 360° tours, detailed specs, HD photos, and immersive videos.',
        icon: <CustomShowroom />,
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-10'>
            {
                ServicesData.map((service) => (
                    ...
                    <Link to={service.link} key={service.id} className="bg-[#F9FAFB] group space-y-4  hover:bg-custom-primary hover:text-white transform transition duration-300 rounded-lg shadow-md p-6 lg:p-10 mb-4">
