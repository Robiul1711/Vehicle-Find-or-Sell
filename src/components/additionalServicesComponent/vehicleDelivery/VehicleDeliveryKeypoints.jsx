    ...
    return (
        <div className='lg:space-y-20 mx-auto'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-10 ">
                <div className="">
                    <img className='w-full' src={ImageProvider.delivery2} alt="" />
                </div>
                <div className="space-y-4 lg:space-y-10">
                    <p className="lg:text-3xl font-bold">
                        Specialized Transport Companies
            ...
            <div >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-10 items-center justify-center">
                    ...
                    <div className="">
                        <img src={ImageProvider.delivery3} className='w-full' alt="" />
                    </div>
                    <div className="space-y-4 lg:space-y-10">
                        {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-10 items-center">
                <div className="">
                    <img className='w-full' src={ImageProvider.delivery4} alt="" />
                </div>
                <div className="space-y-4 lg:space-y-10">
                    <p className="lg:text-3xl font-bold">
                        Other Possible Solutions
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-10 items-center">
                ...
                <div className="">
                    <img className='w-full' src={ImageProvider.delivery5} alt="" />
                </div>
            </div>
