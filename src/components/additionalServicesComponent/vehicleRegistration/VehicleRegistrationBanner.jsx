...
const VehicleRegistrationBanner = () => {
    ...
    return (
        <div className='bg-[#E9F2FF] min-h-[40vh] px-4 flex flex-col justify-center items-center text-center gap-4 text-black '>
            ...
            <p ref={subTextRef} className="text-xl">
                Simple, safe, and 100% online procedures. Get your vehicle registered quickly and efficiently.
            </p>
        </div>
    );
};

export default VehicleRegistrationBanner;