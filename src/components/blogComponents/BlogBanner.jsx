...
const BlogBanner = ({ blogBanner }) => {
  ...
  return (
    <div
      style={{
        backgroundImage: `url(${blogBanner?.hero_background_image_url})`,
    ...
    >
      ...
      <p
        ...
        dangerouslySetInnerHTML={{ __html: blogBanner?.title }}
      ></p>
      <p
        ref={subTextRef}
        className="text-xl text-white relative z-10"
        dangerouslySetInnerHTML={{ __html: blogBanner?.subtitle }}
      ></p>
    </div>
  );
};
