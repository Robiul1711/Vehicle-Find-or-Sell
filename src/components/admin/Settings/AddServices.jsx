...
import {
  ...
  FinancingIcon,
  NewVechleIcon,
  partsAccessoriesIcon,
  RegistrationServiceIcon,
  SecondHandVechleIcon,
...
const AddServices = () => {
  ...
  useEffect(() => {
    if (data?.data) {
      const activeIds = data.data.filter((s) => s.is_active).map((s) => s.id);
    ...
    <div className="p-4 bg-gray-50 rounded-2xl ">
      <div className="">
        ...
        <div className="flex justify-end">
          ...
          >
            {isPending ? "Adding..." : "Update Services"}
          </button>
        </div>
      </div>
    </div>
