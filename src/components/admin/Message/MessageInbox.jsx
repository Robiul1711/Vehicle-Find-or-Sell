...
// react icons
import {LuHeart, LuSend, LuThumbsUp, LuPaperclip, LuX,  LuFile, LuLoader} from "react-icons/lu";
...
const MessageInbox = () => {
    ...
    return (
        <div className="flex flex-col w-full h-full bg-white rounded-t-2xl overflow-hidden">
            <div className="flex items-center gap-2 p-4 border-b border-gray-200">
                <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=40&h=40&fit=crop&crop=face&faceindex=1" alt="" className="w-8 h-8 rounded-full" />
                <h1>Maria Doe</h1>
            </div>
